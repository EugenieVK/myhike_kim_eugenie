...
//-----------------------------------------------------------------------------
// used to create fake hikes in firestore for testing purposes
//-----------------------------------------------------------------------------
function writeHikes() {
...
function displayCardsDynamically(collection) {
    ...
    db.collection(collection)
        .orderBy("hike_time") //What to sort by
        .limit(2) //how many can appear
        ...
        .then(allHikes=> {
            ...
            allHikes.forEach(doc => { //iterate thru each doc
                ...
                var hikeTime = doc.data().hike_time;
                var lastUpdate = doc.data().last_updated.toDate().toLocaleDateString();
                var docID = doc.id; // grab the id for that specific hike doc
                ...
                newcard.querySelector('.card-length').innerHTML = 
                                    ...
                                    "Duration: " + hikeTime + "min <br>" +
                                    "Last updated: " + lastUpdate;
                newcard.querySelector('.card-text').innerHTML = details;
                newcard.querySelector('.card-image').src = `./images/${hikeCode}.jpg`; //Example: NV01.jpg
                newcard.querySelector('a').href = "eachHike.html?docID="  + docID; // BUTTON for read more
                
                //Bookmark Icon unique id creation and button functionality
